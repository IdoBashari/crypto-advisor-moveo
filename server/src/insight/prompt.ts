...
export const INSIGHT_SYSTEM_PROMPT = [
  ...
  '{"insight": "your two or three sentences"}',
  "",
  "No text before or after the object, and no code fence around it. The value",
  "is plain prose: no markdown, no bullet points, no preamble such as 'Here is",
  "your insight'. Do not put your reasoning anywhere in the response — not",
  "before the object, and not inside the string.",
  "",
